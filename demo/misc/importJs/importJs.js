define(function(require){
	...
	// 加载外网, 符合AMD规范的文件
	var outterAMD1 = require("/x5/UI2/demo/misc/importJs/outterAMD1.js");

	// 加载UI2下, 不符合AMD规范的文件
	require("./noneAMD1");
	
	// 加载外网, 不符合AMD规范的文件
	require("/x5/UI2/demo/misc/importJs/outterNoneAMD1.js");
	...
	Model.prototype.importOutterBtnClick = function(event){
		// 加载外网, 符合AMD规范的文件
		var path = "/x5/UI2/demo/misc/importJs/outterAMD2.js";
		require([path], function(m){
			m.fnOfOutterAMD2();
		})
	};
	...
	Model.prototype.importOutterNoneAMDBtnClick = function(event){
		// 加载外网, 不符合AMD规范的文件
		var path = "/x5/UI2/demo/misc/importJs/outterNoneAMD2.js";
		require([path], function(){
			fnOfOutterNoneAMD2();
		})
	};
