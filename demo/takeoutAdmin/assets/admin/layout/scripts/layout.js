...
var Layout = function () {
    ...
    var handleSidebarAndContentHeight = function () {
        ...
        if (body.hasClass("page-footer-fixed") === true && body.hasClass("page-sidebar-fixed") === false) {
            ...
            if (content.height() < available_height) {
                ...
                var contents_height = content.innerHeight() - $(".page-title").outerHeight() - 50;
                $(".page-content >.x-contents").attr('style', 'min-height:' + contents_height + 'px');
            }
        } else {
            ...
            var contents_height = height - $(".page-title").outerHeight() - 50;
            $(".page-content >.x-contents").attr('style', 'min-height:' + contents_height + 'px');
        }
    };
    ...
    var handleSidebarMenu = function () {
            ...
            if (sub.is(":visible")) {
                ...
                sub.slideDown(slideSpeed, function () {
                    if (autoScroll === true && $('.body').hasClass('page-sidebar-closed') === false) {
                        if ($('.body').hasClass('page-sidebar-fixed')) {
                            menu.slimScroll({
                                'scrollTo': (menu.scrollTop()+(the.position()).top)
                            });
                        } else {
                            Metronic.scrollTo(the, slideOffeset);
                        }
        ...
        false && $('.page-sidebar').on('click', ' li > a.ajaxify', function (e) {
            e.preventDefault();
            Metronic.scrollTop();
