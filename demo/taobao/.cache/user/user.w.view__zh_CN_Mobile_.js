...
var __parent0=require('$model/UI2/demo/taobao/user'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__id='';
	this.__cid='cFvuMne';
	this._flag_='97b0cbae74485196646db0831e247692';
	this._wCfg_={};
	this._appCfg_={};
