...
justep.svg.Path.prototype.paintStartArrow = function(){
	if(!this.StartArrow){
...
justep.svg.Path.prototype.removeEndArrow = function(){
	if(this.endArrow){
...
justep.svg.Path.prototype.removeStartArrow = function(){
	if(this.startArrow){
