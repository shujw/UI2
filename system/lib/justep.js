...
define(function(require) {
	...
	var _Number = require("$UI/system/lib/base/number");
	var _baas = require("$UI/system/lib/base/baas");
	...
	justep.callModelFn = function(option){
		return _Util.callModelFn.apply(_Util,arguments);
	};
