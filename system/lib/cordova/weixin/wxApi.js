define(['//res.wx.qq.com/open/js/jweixin-1.0.0.js','$UI/system/lib/base/md5','./sha1','jquery'],function(wx,MD5,Sha1,$,require) {
	function WxApi(appId) {
		this.jsapiTicket = "";
		this.ready = false;
		this.appId = appId;
		this.weixinJSApiUrl = "/baas/weixin/weixin/jsapi";
	}
	...
	WxApi.prototype.chooseWXPay = function(params) {
		...
		this.exec().done(function(wx){
			...
			$.ajax({
				...
				wxJsApiPayDtd.reject("chooseWXPayError");
