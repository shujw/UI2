...
define(function(require) {
	...
	_Date.getFirstDay = function(date){
		...
		if("string" == typeof(date)){
			date = justep.Date.fromString(date, justep.Date.STANDART_FORMAT_SHOT);
		}
		date.setDate(1);
		return justep.Date.toString(date, justep.Date.STANDART_FORMAT_SHOT);
	};
	...
	_Date.getLastDay = function(date){
		...
		date = justep.Date.increase(date,1,'m');
		date.setDate(1);
		date = justep.Date.decrease(date,1,'d');
		return justep.Date.toString(date, justep.Date.STANDART_FORMAT_SHOT) + " 23:59:59";
	};
