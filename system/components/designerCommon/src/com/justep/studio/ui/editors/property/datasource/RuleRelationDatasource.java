...
public class RuleRelationDatasource extends PropertyDatasource {
	...
	public DataSet getDatasource(PropertyItem propertyItem) {
		...
		if(data.getName().equals("$UI/system/components/justep/data/data") || data.getName().equals("$UI/system/components/justep/data/baasData")){
			return (new RelationDatasource()).getDatasource(propertyItem);			
		}
