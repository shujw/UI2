define(function(require) {
	...
	var bizModelService = {
		 ...
		 * 根据数据源获取表信息.
		 */
		getDBTables:function(dsName){
			return __callJava(serviceName, "getDBTables", {dsName:dsName});
		},
		
		/**
		 * 获取表字段名.
		 */
		getTableFields:function(dsName,tableName){
			return __callJava(serviceName, "getTableFields", {dsName:dsName,tableName:tableName});
		}
