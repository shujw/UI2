...
//		this.domNode.setAttribute("tabindex",'0');
		...
		$(this.domNode).on("beforeAddChild",function(event){ 
			event.config = {css:{width:200+"px",position:'absolute'}};
			event.width = 200;
	...
	var quickIdeEx = {
			"$UI/system/components/justep/absoluteLayout/absoluteLayout":{
				//properties:["title"],
								...
								items : [ {
									...
									optionData : 
										[{propName : "class",value : "",text : "<button class='btn btn-success btn-sm' style='margin:6px;width:70px;'>无</button>"},
										 {propName : "class",value : "x-cell-layout",text : "<button class='btn btn-success btn-sm' style='margin:6px;width:70px;'>cell样式</button>"}
										],
										editor : "listEditor"
									} ]
							},
	...
	return {
		'$UI/system/components/justep/absoluteLayout/absoluteLayout' : absoluteLayout,quickIdeEx:quickIdeEx
	};
});