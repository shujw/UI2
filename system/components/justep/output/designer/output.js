...
define(function(require) {
	...
	var webIdeEx = {
			"$UI/system/components/justep/output/output":{
	...
	return {
		'$UI/system/components/justep/output/output' : Output,webIdeEx:webIdeEx,quickIdeEx:quickIdeEx
	};
});