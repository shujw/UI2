...
//                }
    ...
    var Upload = {
        ...
        uploadFile: function(f,callback){
        	...
        	if(!me.editor.options.fileActionUrl) throw new Error('请设置上传文件的Url');
			$.ajax({
				method:"GET",
				url:me.editor.options.fileActionUrl + "/presignedPutObject",
				data:{
					objectName:fileName
				},
				xhrFields: {
			   ...
			   headers:{
				   apiKey:me.editor.options.appkey
			   }
	            ...
	            xhr.addEventListener('load', function (e) {
	    			$.ajax({
	    				method:"GET",
	    				url:me.editor.options.fileActionUrl + "/presignedGetObject",
	    				data:{
	    					objectName: fileName,
	    					expires: 604800
	    				},
