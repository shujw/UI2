define(function(require){
	...
	v.JUSTEP230108='{"code":"JUSTEP230108", "message":"回退首环节"}';
	v.JUSTEP230109='{"code":"JUSTEP230109", "message":"网络出错"}';
	v.JUSTEP230110='{"code":"JUSTEP230110", "message":"打开页面{0}出错"}';
	v.JUSTEP230111='{"code":"JUSTEP230111", "message":"打开对话框出错"}';
	
	v.JUSTEP230112='{"code":"JUSTEP230112", "message":"页面已经被关闭"}';
	v.JUSTEP230113='{"code":"JUSTEP230113", "message":"Model上没有定义{0}方法"}';
	v.JUSTEP230114='{"code":"JUSTEP230114", "message":"执行不存在的操作{0}"}';
	...
	v.JUSTEP231102='{"code":"JUSTEP231102", "message":"注册ExtendType：{0}失败，Model对象无效"}';
	v.JUSTEP231103='{"code":"JUSTEP231103", "message":"打印"}';
	v.JUSTEP231104='{"code":"JUSTEP231104", "message":"预览"}';
	v.JUSTEP231105='{"code":"JUSTEP231105", "message":"ID={0}的数据行不存在"}';
	v.JUSTEP231106='{"code":"JUSTEP231106", "message":"输入密码不一致，请重新设置"}';
	v.JUSTEP231107='{"code":"JUSTEP231107", "message":"请再次输入密码"}';
	v.JUSTEP231108='{"code":"JUSTEP231108", "message":"密码匹配成功"}';
	v.JUSTEP231109='{"code":"JUSTEP231109", "message":"密码错误"}';
	v.JUSTEP231110='{"code":"JUSTEP231110", "message":"设置密码成功"}';
	v.JUSTEP231111='{"code":"JUSTEP231111", "message":"显示列..."}';
	v.JUSTEP231112='{"code":"JUSTEP231112", "message":"隐藏列"}';
	v.JUSTEP231113='{"code":"JUSTEP231113", "message":"按该列分组"}';
	v.JUSTEP231114='{"code":"JUSTEP231114", "message":"调整列..."}';
	v.JUSTEP231115='{"code":"JUSTEP231115", "message":"保存布局"}';
	v.JUSTEP231116='{"code":"JUSTEP231116", "message":"取消布局"}';
	v.JUSTEP231117='{"code":"JUSTEP231117", "message":"创建Timer组件必须给出有效的model参数"}';
	v.JUSTEP231118='{"code":"JUSTEP231118", "message":"没有符合条件的数据"}';
	v.JUSTEP231119='{"code":"JUSTEP231119", "message":"无效的过滤列"}';	
	v.JUSTEP231120='{"code":"JUSTEP231120", "message":"查找数据的data[{0}]不存在"}';	
	v.JUSTEP231121='{"code":"JUSTEP231121", "message":"加载页"}';
	v.JUSTEP231122='{"code":"JUSTEP231122", "message":"加载页url,类似  {url:\'$UI/portal/index.w\'} 或者 \'$UI/portal/index.w\'"}';
	v.JUSTEP231123='{"code":"JUSTEP231123", "message":"显示页"}';	
	v.JUSTEP231124='{"code":"JUSTEP231124", "message":"打开的页Url,类似  {url:\'$UI/portal/index.w\'} 或者 \'$UI/portal/index.w\'"}';	
	v.JUSTEP231125='{"code":"JUSTEP231125", "message":"传递到页面的参数"}';	
	v.JUSTEP231126='{"code":"JUSTEP231126", "message":"显示左边栏"}';	
	v.JUSTEP231127='{"code":"JUSTEP231127", "message":"显示右边栏"}';	
	v.JUSTEP231128='{"code":"JUSTEP231128", "message":"关闭页面"}';	
	v.JUSTEP231129='{"code":"JUSTEP231129", "message":"关闭页Url,类似  {url:\'$UI/portal/index.w\'} 或者 \'$UI/portal/index.w\',缺省关闭当前页"}';	
	v.JUSTEP231130='{"code":"JUSTEP231130", "message":"显示首页"}';	
	v.JUSTEP231131='{"code":"JUSTEP231131", "message":"执行"}';	
	v.JUSTEP231132='{"code":"JUSTEP231132", "message":"发送消息"}';	
	v.JUSTEP231133='{"code":"JUSTEP231133", "message":"消息"}';	
	v.JUSTEP231134='{"code":"JUSTEP231134", "message":"data赋值"}';	
	v.JUSTEP231135='{"code":"JUSTEP231135", "message":"data所有行赋值"}';	
	v.JUSTEP231136='{"code":"JUSTEP231136", "message":"get请求"}';	
	v.JUSTEP231137='{"code":"JUSTEP231137", "message":"data组件"}';	
	v.JUSTEP231138='{"code":"JUSTEP231138", "message":"行,缺省当前行"}';	
	v.JUSTEP231139='{"code":"JUSTEP231139", "message":"列"}';	
	v.JUSTEP231140='{"code":"JUSTEP231140", "message":"值"}';
	v.JUSTEP231141='{"code":"JUSTEP231141", "message":"同步请求，默认异步"}';
	v.JUSTEP231142='{"code":"JUSTEP231142", "message":"url[{0}]加载数据失败"}';
	v.JUSTEP231143='{"code":"JUSTEP231143", "message":"消息标识"}';
	v.JUSTEP231144='{"code":"JUSTEP231144", "message":"清除手势"}';
	v.JUSTEP231145='{"code":"JUSTEP231145", "message":"设置模式"}';
	v.JUSTEP231146='{"code":"JUSTEP231146", "message":"模式"}';
	v.JUSTEP231147='{"code":"JUSTEP231147", "message":"设置密码"}';
	v.JUSTEP231148='{"code":"JUSTEP231148", "message":"密码(逗号分隔的数字串)"}';
	v.JUSTEP231149='{"code":"JUSTEP231149", "message":"触发次数"}';
	v.JUSTEP231150='{"code":"JUSTEP231150", "message":"间隔时间"}';
	...
	v.JUSTEP231516='{"code":"JUSTEP231516", "message":"无效的日期时间"}';
	...
	v.JUSTEP232036='{"code":"JUSTEP232036", "message":"查询文档信息失败，可能文档被删除！"}';
	...
	v.JUSTEP232125='{"code":"JUSTEP232125", "message":"查询文档信息失败，可能文档已经删除！"}';
	...
	v.JUSTEP233002='{"code":"JUSTEP233010", "message":"切换"}';
	...
	v.JUSTEP281008='{"code":"JUSTEP281008", "message":"登录系统后才能执行 biz action 请求"}';
