...
(function(e, t) {
	...
	var e = function(e, t) {
			var n, o, i, a, r, l, s, u, c, d, p, m, f, h, v, y, x = this,
				...
				M = function(n) {
					for (var o = 0; e.options.closeElClasses.length > o; o++) if (t.hasClass(n, "pswp__" + e.options.closeElClasses[o])) return !0
				},
				F = 0,
				S = function() {
			...
			x.init = function() {
				...
				r("onPinchClose", function(e) {
					...
					if (T()) {
						...
						if (e.options.captionEl && "auto" === l.bottom) if (a || (a = t.createEl("pswp__caption pswp__caption--fake"), a.appendChild(t.createEl("pswp__caption__center")), o.insertBefore(a, i), t.addClass(o, "pswp__ui--fit")), e.options.addCaptionHTMLFn(n, a, !0)) {
				...
				if (!f) if (n.detail && "mouse" === n.detail.pointerType) M(o) && e.close(), t.hasClass(o, "pswp__img") && (1 === e.getZoomLevel() && e.getZoomLevel() <= e.currItem.fitRatio ? e.close() : e.toggleDesktopZoom(n.detail.releasePoint));
