	...
	var e = function(e, t, n, i) {
			...
			o.detectFeatures(), o.features.oldIE && (o.bind = function(e, t, n, i) {
				...
				for (var o, a = (i ? "detach" : "attach") + "Event", r = function() {
					...
					}, l = 0; t.length > l; l++) if (o = t[l]) if ("object" == typeof n && n.handleEvent) {
					if (i) {
			...
			var u, c, d, m, p, f, h, y, v, x, g, w, b, I, D, C, T, M, Z, S, A, k, O, E, R, F, P, L, z, N, _, U, H, Y, B, V, W, G, X, K, q, $, j, J, Q, et, tt, nt, it, ot, at, rt, lt, st, ut, ct, dt, mt, pt, ft, ht, yt, vt, xt, gt = function() {
				...
				cn = {
					...
					updateSize: function(t) {
						...
						if (Tt.x = a.scrollWrap.clientWidth, Tt.y = a.scrollWrap.clientHeight, lt = {
							x: 0,
							y: N
						}, St.x = Tt.x + Math.round(Tt.x * s.spacing), St.y = Tt.y, Vt(St.x * Mt), zt("beforeResize"), void 0 !== f) for (var i, r, u = 0; l > u; u++) i = C[u], Bt((u + f) * St.x, i.el.style), r = yt(i.index), r.needsUpdate && (a.cleanSlide(r), a.setContent(i, i.index), 1 === u && a.updateCurrZoomItem(!0), r.needsUpdate = !1), r && r.container && (Jn(r, Tt), Yt(r));
				...
				Yn = function() {
					if (Q) {
						...
						if (0 !== e) if (qt(pn, Q[0]), hn.x = pn.x - yn.x, hn.y = pn.y - yn.y, et && e > 1) {
							...
							var i = 1;
							if (a.currItem.minZoom > n) if (s.pinchToClose && !dt && a.currItem.initialZoomLevel >= g) {
				...
				Bn = function(e) {
					...
					if (O) {
						...
						if (n > -1) if (t = xn.splice(n, 1)[0], navigator.pointerEnabled) t.type = e.pointerType || "mouse";
						else {
							var i = {
								4: "mouse",
								2: "touch",
			...
			var li, si, ui, ci, di, mi, pi, fi, hi, yi, vi, xi = {
				...
				bi = function() {
					...
					for (var n = e.split("&"), i = 0; n.length > i; i++) if (n[i]) {
						var o = n[i].split("=");
